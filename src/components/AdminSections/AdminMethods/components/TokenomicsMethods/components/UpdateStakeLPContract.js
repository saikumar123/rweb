...
const UpdateStakeLPContract = (props) => {
              ...
              <div className="col-lg-12 m-b-10">
                <div className=" my-2 ">
                  <small
                    ...
                    style={{ fontSize: "18px" }}
                  >
                    Update Stake LP Contract Address
                  </small>
                </div>
              </div>
...
UpdateStakeLPContract.propTypes = {};

UpdateStakeLPContract.defaultProps = {};

export default connect(mapStateToProps)(UpdateStakeLPContract);
