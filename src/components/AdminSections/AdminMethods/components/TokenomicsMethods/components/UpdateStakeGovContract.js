...
const UpdateStakeGovContract = (props) => {
              ...
              <div className="col-lg-12 m-b-10">
                <div className=" my-2 ">
                  <small
                    ...
                    style={{ fontSize: "18px" }}
                  >
                    Update Stake Gov Contract Address
                  </small>
                </div>
              </div>
...
UpdateStakeGovContract.propTypes = {};

UpdateStakeGovContract.defaultProps = {};

export default connect(mapStateToProps)(UpdateStakeGovContract);
