...
const UpdateEscrowContract = (props) => {
...
UpdateEscrowContract.propTypes = {};

UpdateEscrowContract.defaultProps = {};

export default connect(mapStateToProps)(UpdateEscrowContract);
