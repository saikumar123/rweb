  ...
  return (
    <div class="row m-b-30 blueTxt">
      ...
      <div class="col-lg-3">
        ...
        <input type="text" disabled="disabled" class="form-control" value={balance1} placeholder="" />
        <br />
      ...
      <div class="col-lg-3">
        ...
        <input type="text" disabled="disabled" class="form-control" value={balance2} placeholder="" />
        <br />
      ...
      <div class="col-lg-3">
        ...
        <input type="text" class="form-control" disabled="disabled" value={balance3} placeholder="" />
      </div>
      <div class="col-lg-1 "></div>
